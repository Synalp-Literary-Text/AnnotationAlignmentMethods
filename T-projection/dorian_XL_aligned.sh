...
python3 calculate_scores_nmts.py \
  --jsonl_path Dorian_al/mt5-xl/fr.dorian_aligned.REFQUOTE_3_2.jsonl \
  --model_name_or_path facebook/m2m100_418M \
  --output_path Dorian_al/mt5-xl/fr.dorian_aligned.REFQUOTE_3_2.json \
  --source_lang en \
  --target_lang fr \
  --normalize \
  --both_directions
...
python3 label_projection.py \
  --jsonl_path Dorian_al/mt5-xl/fr.dorian_aligned.REFQUOTE_3_2.jsonl \
  --dictionary_path Dorian_al/mt5-xl/fr.dorian_aligned.REFQUOTE_3_2.json \
  --output_path Dorian_al/mt5-xl/en2fr.dorian_aligned.REFQUOTE_3_2.conll
